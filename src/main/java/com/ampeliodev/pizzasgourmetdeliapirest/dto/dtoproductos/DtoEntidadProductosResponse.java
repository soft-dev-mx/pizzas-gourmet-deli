...
public class DtoEntidadProductosResponse {
    ...
    public DtoEntidadProductosResponse() {
    }

    public DtoEntidadProductosResponse(int idProducto, String nombreProducto, String categoriaProducto, int claveProducto, double precioProductoMini, double precioProductoIndividual, double precioProductoChica, double precioProductoMediana, double precioProductoGrande, double precioProductoFamiliar, double precioProductoOtros, String descripcionProducto, String imagenProducto) {
